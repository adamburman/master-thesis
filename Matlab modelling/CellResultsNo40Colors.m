...
for i = 1:numStrategies
    ...
    plot(timeData, temperatures, 'Color', colorMap(i,:), ...
         'DisplayName', labels{i}, 'LineWidth', 1.5);
end
...
for i = 1:numStrategies
    ...
    plot(timeData, coreTemperatures, 'Color', colorMap(i,:), ...
         'DisplayName', labels{i}, 'LineWidth', 1.5);
end
...
xlabel('Time (s)');
ylabel('Temperature (°C)');
title('Temperature for Tube-based MPC');
legend('show', 'Location', 'best');
grid on;
hold off;
...
for i = 1:numStrategies
    ...
    plot(timeData, 100.*SoE, 'Color', colorMap(i,:), ...
         'DisplayName', labels{i}, 'LineWidth', 1.5);
    % xline(timeData(end), 'Color', colorMap(i,:), 'HandleVisibility','off')
    end
end

xlabel('Time [s]');
ylabel('State of Energy [%]');
title('Calculated State of Energy');
legend('show', 'Location', 'best');
grid on;
hold off;
