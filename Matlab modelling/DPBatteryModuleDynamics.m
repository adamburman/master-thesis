function xNext = DPBatteryModuleDynamics(x, u, deltaT)
    % Extract states
    SoC = x(1);
    SoE = x(2);
    V1 = x(3);
...
% Ad = [
%     1, 0, 0, 0;
%     0, 0.654412548904511, 0, 0;
%     0, 1.21865396754729e-05, 0.992929607041922, 0.00267321238574706;
%     0, 0.00850783472673841, 3.29496848423763e-05, 0.999966977528611
% ];
% 
% % Define the vector 'Bd'
% Bd = [
%    -1.78062678062678e-06;
%     0.000704495371536788;
%     2.94616982603525e-08;
%     2.32361631148065e-05
% ];
